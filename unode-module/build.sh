...
case "$OSTYPE" in
  msys*)
    ...
    #"$UNITY_EXE" -quit -batchmode -nographic -logFile - -projectPath "." -buildWindows64Player "Build.app/UnityPlayer.exe"
  ...
  darwin*)
    ...
    #"$UNITY_EXE" -quit -batchmode -nographic -logFile - -projectPath "." -buildOSXUniversalPlayer "Build.app"
    #cd Build_BackUpThisFolder_ButDontShipItWithYourGame/Managed/
    ;;
esac

"$UNITY_EXE" -quit -batchmode -nographic -logFile - -projectPath "." -activeBuildProfile "Assets/Settings/Build Profiles/WebDev.asset" -build "Build.web"
